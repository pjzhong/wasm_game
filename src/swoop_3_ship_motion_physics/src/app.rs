...
impl App {
    ...
    pub fn key_event(&mut self, event: KeyboardEvent) {
        ...
        if event.code() == "ShiftLeft" {
            if player_entity.angular_thrust < 0.0 {
                player_entity.angular_thrust = -0.2;
            } else if 0.0 < player_entity.angular_thrust {
                player_entity.angular_thrust = 0.2;
            }
            if player_entity.linear_thrust < 0.0 {
                player_entity.linear_thrust = -0.5;
            } else if 0.0 < player_entity.linear_thrust {
                player_entity.linear_thrust = 0.05;
            }
        }
